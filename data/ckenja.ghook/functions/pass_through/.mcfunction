...
## 視線元の場所 4桁
## 視線の方向 4桁
execute positioned ^0.00005 ^0.00005 ^0.00005 summon minecraft:marker run function ckenja.ghook:pass_through/get_formula
...
execute if data storage util:_ out[0] run function ckenja.ghook:pass_through/reverse
