...
scoreboard objectives add ckenja.ghook.hook.x dummy
scoreboard objectives add ckenja.ghook.hook.y dummy
scoreboard objectives add ckenja.ghook.hook.z dummy
