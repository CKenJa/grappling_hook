...
execute store result score #temp.x ckenja.ghook run data get storage ckenja.ghook.__temp__: player.Motion[0] 98000
execute store result score #temp.y ckenja.ghook run data get storage ckenja.ghook.__temp__: player.Motion[1] 98000
execute store result score #temp.z ckenja.ghook run data get storage ckenja.ghook.__temp__: player.Motion[2] 98000
data modify storage ckenja.ghook.__temp__: pig.not_hooked set from entity @s Motion
execute store result score #temp.x.motion ckenja.ghook run data get storage ckenja.ghook.__temp__: pig.not_hooked[0] 9800
execute store result score #temp.y.motion ckenja.ghook run data get storage ckenja.ghook.__temp__: pig.not_hooked[1] 9800
execute store result score #temp.z.motion ckenja.ghook run data get storage ckenja.ghook.__temp__: pig.not_hooked[2] 9800
