...
execute unless score @s ckenja.ghook matches -2147483648..2147483647 positioned as @s run scoreboard players operation @s ckenja.ghook = @e[type=player,sort=nearest,limit=1] ckenja.ghook
