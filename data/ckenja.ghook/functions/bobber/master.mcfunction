...
execute if entity @s[tag=ckenja.ghook.bobber,tag=ckenja.ghook.bobber.hooked] if score #test ckenja.ghook matches 1 run data modify entity @s Fire set value 1s
execute if entity @s[tag=ckenja.ghook.bobber,tag=ckenja.ghook.bobber.hooked] if score #test ckenja.ghook matches 0 run data modify entity @s Fire set value 0s
execute if entity @s[tag=ckenja.ghook.bobber,tag=ckenja.ghook.bobber.hooked] if score #test ckenja.ghook matches 0 run data modify entity @s Motion set value [0.0,0.05625,0.0]
