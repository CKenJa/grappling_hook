...
scoreboard players operation #feature.swing.k ckenja.ghook -= #player.pos.x ckenja.ghook
scoreboard players operation #feature.swing.k ckenja.ghook *= #10000 ckenja.ghook
scoreboard players operation #feature.swing.k ckenja.ghook /= #moving_vector.x ckenja.ghook
