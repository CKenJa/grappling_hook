#> ckenja.ghook:feature/swing/collision_responce/_3
#
#
#
# @within function ckenja.ghook:feature/swing/collision_responce/_2
...
#衝突向きのベクトルを消したうえで力を再計算する。
    ...
    execute facing entity @s feet run function ckenja.ghook:feature/swing/collision_responce/re_collision_detection
    #function ckenja.ghook:feature/swing/collision_detection/tp
