...
tp @s ~ ~ ~
execute store result score #feature.swing.k ckenja.ghook run data get entity @s Pos[2] 10000

scoreboard players operation #feature.swing.t ckenja.ghook = #feature.swing.k ckenja.ghook
scoreboard players operation #feature.swing.t ckenja.ghook -= #player.pos.z ckenja.ghook
scoreboard players operation #feature.swing.t ckenja.ghook *= #10000 ckenja.ghook
scoreboard players operation #feature.swing.t ckenja.ghook /= #moving_vector.z ckenja.ghook
