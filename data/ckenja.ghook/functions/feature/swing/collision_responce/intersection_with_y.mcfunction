...
#
#
# @within function ckenja.ghook:feature/swing/collision_responce/intersection_with_y
tp @s ~ ~ ~
...
scoreboard players operation #feature.swing.k ckenja.ghook -= #player.pos.y ckenja.ghook
scoreboard players operation #feature.swing.k ckenja.ghook *= #10000 ckenja.ghook
scoreboard players operation #feature.swing.k ckenja.ghook /= #moving_vector.y ckenja.ghook
