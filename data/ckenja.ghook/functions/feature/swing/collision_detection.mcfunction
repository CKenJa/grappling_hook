...
execute if score #feature.swing.collision ckenja.ghook matches 0 unless score #feature.swing.collision.neared ckenja.ghook matches 1 run function ckenja.ghook:feature/swing/collision_responce
