...
execute if score #feature.swing.collision ckenja.ghook matches 0 unless score #feature.swing.collision.neared ckenja.ghook matches 1 as @a[tag=ckenja.ghook.feature.swing.player,distance=..120] on vehicle run tp @s ~ ~0.6 ~
